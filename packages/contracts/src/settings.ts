...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    provider: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Optional Pi --provider value, for example anthropic, openai, or google.",
    ...
    model: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Pi model",
        description: "Optional Pi --model value, for example sonnet:high.",
        providerSettingsForm: { placeholder: "sonnet:high", clearWhenEmpty: "omit" },
      }),
    ),
    sessionDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Optional Pi session directory override.",
    ...
    configDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Optional PI_CODING_AGENT_DIR override.",
    ...
    launchArgs: Schema.String.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional Pi CLI arguments passed when starting a session.",
